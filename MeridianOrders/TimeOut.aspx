...
<div id="page">
	...
	<h1>Standard Planner Orders</h1>
		
	<p>Your Session has timed out please re-enter your order.</p>
    	
			<asp:LinkButton ID="LinkButton1" runat="server"  
            PostBackUrl="~/Standard_Orders.aspx">Back To Order Page</asp:LinkButton>
	</div>
    </div>
