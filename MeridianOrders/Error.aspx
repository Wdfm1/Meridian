...
<form id="form1" runat="server">
    ...
    <div class="title" style="padding-bottom:40px; padding-top:30px">
	<asp:Label ID="lblerror" runat="server"      
        Text="A technical error has occurred. Please try to place your order again or contact Meridian customer service at 888-724-8512"></asp:Label><br />
        <asp:LinkButton
            ID="LinkButton1" runat="server" PostBackUrl="~/Standard_Orders.aspx">To Main Page</asp:LinkButton>
	</div>
    
	<div class="Col_one_900">
            <em>
            <asp:Label ID="Label2" runat="server" Text="Please do not hit the back button. ">
            </asp:Label>
      </em>	</div>
</div>
