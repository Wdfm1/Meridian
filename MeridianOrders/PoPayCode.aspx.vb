...
Partial Class PoPayCode
	...
	Protected Sub Button1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
		...
		If Page.IsValid Then
			...
			Dim cschcode As String = CustomerCode.Text.Trim
			...
			If cschcode.Length = 6 Then
				cus11.SelectParameters.Add("@schcode", cschcode)
			Else
				SetErrorMessage(2)
			End If
			...
			Response.Redirect("https://www.securepaymentportal.com/MeridianSecure/PoPay.aspx?schcode=" & schcode)
	...
	Private Sub SetErrorMessage(ByVal errcode As Integer)
		...
		Select Case errcode
			Case 1 ''no connection
				...
				Dim rdirect As String = "PoPayCode.aspx"
	...
	Protected Sub cv11_ServerValidate(source As Object, args As System.Web.UI.WebControls.ServerValidateEventArgs) Handles cv11.ServerValidate
