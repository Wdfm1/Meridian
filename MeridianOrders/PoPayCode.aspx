<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PoPayCode.aspx.vb" Inherits="PoPayCode" %>
...
<div style="font-weight: bold; color: #FF0000">
  <%Response.Write(Session("defaulterrormessage"))%>
  </div>
	<div>
   <div>
   <p style="font-weight: bold">
       ...
       <p style="font-weight: bold">
       <asp:Label ID="Label1" runat="server" Text="School Code:"></asp:Label>
       <asp:TextBox
           ID="CustomerCode" runat="server"></asp:TextBox>
           &nbsp;&nbsp;
           <asp:Button ID="Button1" runat="server" Text="Next" Width="47px" />
           &nbsp;<asp:CustomValidator ID="cv11" runat="server" 
				ErrorMessage="Requires a 6 digit code." 
				ControlToValidate="CustomerCode"></asp:CustomValidator></p>
   </div> 
	  ...
	  <div class="row">
        <div class="col-sm-3">
               ...
               <asp:SqlDataSource ID="cus11" runat="server" 
                   ...
                   SelectCommand="SELECT schcode, schname, schaddr, schaddr2, schcity, schstate, schzip, schphone, schfax FROM cust WHERE (schcode = @schcode)"></asp:SqlDataSource>
